      ...
      module Net
        ...
        def restore
          ...
          if @resources.has_key?("net_in")
            @resources["net_in"].each do |host_port, container_port, host_ip|
              _net_in(host_port, container_port, host_ip)
            end
          end
        ...
        def _net_in(host_port, container_port, host_ip)
        ...
        def do_net_in(request, response)
          ...
          @resources["net_in"] ||= []
          @resources["net_in"] << [host_port, container_port, host_ip]
